...
const AdminLogin = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            localStorage.setItem('admin_username', payload.unique_name || payload.name || username);
            localStorage.setItem('admin_email', email || payload.email || '');
            localStorage.setItem('admin_fullName', fullName || payload.fullName || '');
    ...
    return (
        <div className="container mt-5" style={{ maxWidth: 500 }}>
            <h3 className="mb-4 fw-bold">Đăng Nhập Quản Trị Viên</h3>
